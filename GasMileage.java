/*
* A simple calculator to find your cars ability to make it a certain distance with it's given fuel level.
* Also, will indicate the required distance-to-fuel-ratio required to make the required distance. 
 */
package miniProject;
...
public class GasMileage {
    public static void main(String[] args){
        ...
        if(gasRem*carMpg < distNext){
            ...
            System.out.println("with your current fuel levels the minimumn distance to fuel ratio will be: " + distNext/gasRem + " to make the next station");
        }else{
